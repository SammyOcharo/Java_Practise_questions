//java program to change integers to string but only works upto 4 digits
public class ninthMayQ2 {
        ...
        while (x < num.length){
            ...
            else
            {
                ...
                if (num[x] - '0' == 1){
                    ...
                    // we will access the 8th index in two digits[] array i.e. Seventeen
